...
if  __name__ == '__main__':
    ...
    description = ("Convert an OpenDocument to another format. Possible "
            "combinations: ods to odt (tables and styles), odp to html, and "
